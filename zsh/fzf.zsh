...
export FZF_DEFAULT_COMMAND='fd --hidden --follow --exclude={.git,.idea,.vscode,node_modules,build,venv,.wine,.deepinwine,.w3m,.vim,."Tencent Files",."pylint.d",Downloads,Documents,pkg,.local,.cache}'
